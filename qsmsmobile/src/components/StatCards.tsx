  ...
  return (
    <View className="flex-row justify-between w-full gap-3 mt-2">
      ...
      <View className="flex-1 bg-white p-4 rounded-2xl border border-gray-100 shadow-sm">
        ...
        <Text className="text-2xl font-bold">1,248</Text>
        <Text className="text-xs text-gray-500 mt-1">Sent Today</Text>
      </View>
      ...
      <View className="flex-1 bg-white p-4 rounded-2xl border border-gray-100 shadow-sm">
        ...
        <Text className="text-xs text-gray-500 mt-1">Active Now</Text>
      </View>
